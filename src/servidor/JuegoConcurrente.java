...
public class JuegoConcurrente {
	...
	public synchronized ResultadoConcurrente intentarLetra(String nombreJugador, char letra) {
		...
		if (partidaTerminada) {
			return new ResultadoConcurrente(false, "Partida terminada. Ganador: " + ganador, false, false, false,
					nombreJugador);
		}
		if (letrasUsadas.contains(letra)) {
			return new ResultadoConcurrente(false, "Ya se utilizo esa letra \n", false, false, false, nombreJugador);
		}
		...
		return new ResultadoConcurrente(acierto, mensaje, completada, perdido, esGanador, nombreJugador);
	}
