...
public class Juego {
	...
	private static List<String> palabras = new ArrayList<>();// Guardamos palabbras para no hacer tantas llamadas a la
																// API
	...
	private static String obtenerPalabraPorDefecto() {
		String[] palabrasDefecto = { "gato", "perro", "casa", "mesa", "silla", "libro", "papel", "lapiz", "agua",
				"fuego", "tierra", "cielo", "sol", "luna", "estrella", "montaña", "rio", "mar", "playa", "bosque",
	...
	// Intento de una letra y devuelve un objeto ResultadoIntento con datos del
	// turno
	...
	public static class ResultadoIntento {
		...
		public ResultadoIntento(boolean acierto, String mensaje, boolean ganado, boolean perdido) {
