    ...
    private void procesarMensajeServidor(Mensaje mensaje) {
        ...
        if (tipo.equals(Mensaje.BIENVENIDA)) {
            ...
            if (contenido.contains("Partida finalizada")) {
                ...
                cerrar = true; // Esto hace que el hilo principal deje de pedir input
            }
        ...
        } else if (tipo.equals(Mensaje.PREGUNTAR_CONTINUAR)) {
            System.out.println("\n" + contenido);
...
//Lee del teclado y se envía mensaje al servidor
   ...
   // Crea un objeto y lo envia al servidor
    ...
    private void cerrarRecursos(Socket socket, ObjectOutputStream salida, 
            ObjectInputStream entrada, Scanner scanner) {
		cerrar = true;
